...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
            <img src="img/sign-up-background.jpg" class="img-responsive sign-up-img" >
            <div class="top-left display-4 text"><p>Welcome to Masoko<br>It's free for life</p></div>
        </div>
            ...
            <div class="form-data">              
                <form action="php/sign-up-action.php" method="post" class="sign-up">
                    ...
                    <div class="form-group">
                     ...
                     <button type="submit" name="s-u-submit" id="s-u-submit" class="btn btn-primary">Join Masoko</button>
                </form>
            </div>
        </div>
    </div>
